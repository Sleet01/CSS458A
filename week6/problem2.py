...
def main():
    """main function; runs a number of simulations (default 10) of the amount
    of trees in a 17 x 17 grid of trees that would be burned at various
    ignition probabilities between 10% through 90%.
    """
